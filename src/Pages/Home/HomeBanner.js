...
const HomeBanner = () => {
  ...
  const {text} = useTypewriter({
    words: ['Kawser Uzzaman.', 'Junior Web Developer.'],
    loop: 0,
  })
      ...
      <div className="hero min-h-screen bg-white">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <h1 style={{fontFamily:'Public Sans, sans-serif'}} className="text-5xl text-accent font-bold">Hello, I'm <span className="text-primary">
              {text}
              </span> </h1>
            <p className="py-6">
